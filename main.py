...
def ruta_recurso(nombre_archivo):
    ruta_local = os.path.join(ruta_base_app(), nombre_archivo)
...
def inicializar_archivo_json(nombre_archivo):
    ruta_destino = os.path.join(ruta_base_app(), nombre_archivo)

    if os.path.exists(ruta_destino):
        return ruta_destino

    ruta_origen = ruta_recurso(nombre_archivo)
    if os.path.exists(ruta_origen) and ruta_origen != ruta_destino:
        try:
